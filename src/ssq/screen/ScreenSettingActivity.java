...
{
  private static final String 取消                         = "取消";
  private static final String 确定                         = "确定";
  private static final String 请输入一个0_255之间的整数_如果超出范围_将截取 = "请输入一个0-255之间的整数. \n如果超出范围, 将截取. ";
  private static final String 设置颜色分量                     = "设置颜色分量";
  private static final String 请检查输入格式                    = "请检查输入格式";
  ...
  private OnClickListener         onClickListener         = new OnClickListener()
                                                          {
                                                            ...
                                                            public void onClick(final View v)
                                                            {
                                                              ...
                                                              new AlertDialog.Builder(ScreenSettingActivity.this).setTitle(设置颜色分量).setMessage(请输入一个0_255之间的整数_如果超出范围_将截取).setIcon(android.R.drawable.ic_dialog_info).setView(editText).setPositiveButton(确定, new DialogInterface.OnClickListener()
                                                              {
                                                                @Override
